...
export default function MobileNav() {
  ...
  return (
    <div>
      ...
      <div id="menu" className="text-lg shadow hidden fixed grid bg-slate-950 backdrop-blur-sm pt-10 space-y-4 justify-center items-center place-content-start w-full h-screen z-10">
        <Link href="/">Logo</Link>
        <Link href="/">Home</Link>
